...
{
    class TimezoneLookupExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/timezonelookup";

        /// <summary>
        /// Make a GET request to the Timezone Lookup API
        /// </summary>
        static async Task<JsonDocument> CallTimezoneLookupAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;city&quot;] &#x3D; &quot;Harare&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Timezone Lookup API...\n");

            var result = await CallTimezoneLookupAPI();
