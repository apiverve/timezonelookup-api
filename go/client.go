// Package timezonelookup provides a Go client for the Timezone Lookup API.
//
// For more information, visit: https://timezonelookup.apiverve.com?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/timezonelookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Timezone Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Timezone Lookup API client.
...
// Execute makes a request to the Timezone Lookup API with typed parameters.
//
...
//   - city (required): string - The city name for which you want to get the data (e.g., Harare)
