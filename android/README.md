...
```gradle
dependencies {
    implementation 'com.github.apiverve:timezonelookup-api:1.1.13'
}
```
...
```java
import com.apiverve.timezonelookup.TimezoneLookupAPIClient;
import com.apiverve.timezonelookup.APIResponse;
import com.apiverve.timezonelookup.APIException;

// Initialize the client
TimezoneLookupAPIClient client = new TimezoneLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("city", "Harare");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/timezonelookup](https://docs.apiverve.com/ref/timezonelookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/timezonelookup](https://docs.apiverve.com/ref/timezonelookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/timezonelookup-api/issues)
